 ...
 *
 * After login, SecurityConfig sends users to /products (the catalogue). After
 * registration, AuthController sends users to /products too. This controller
 * handles any explicit /dashboard request and redirects to the page appropriate
 * for the user's role.
 *
